...
/**
 * @author 崔航
 * @date 2021/2/10 14:30
 */
@Component
@ArticleStatusAnnotation(ArticleStatus.APPROVAL_REJECTED)
public class ApprovalRejected extends ArticleDatabase implements Status {
    ...
    public void pass(Long id) {
        throw new ValidationException("审批已拒绝请重新提交审批");
    }
    ...
    public void reject(Long id) {
        throw new ValidationException("审批已拒绝无需重复审批");
    }
    ...
    public void revoke(Long id) {
        throw new ValidationException("审批已拒绝无法撤销审批");
    }
    ...
    public void publish(Long id) {
        throw new ValidationException("审批已拒绝不允许发布");
    }
